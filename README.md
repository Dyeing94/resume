...
cd d:\resume_chinese_cmd; & "D:\latex\miktex\bin\x64\xelatex.exe" -interaction=nonstopmode resume.tex
...
# 安装所需宏包（可能需要sudo）
sudo tlmgr install realscripts xifthen ifmtarg fontawesome nth xeCJK relsize titlesec enumitem tabu environ trimspaces tocloft fontawesome5

# 配置 FontAwesome 字体
sudo cp $(kpsewhich -var TEXMFDIST)/fonts/map/dvips/fontawesome/fontawesome.map 
  /usr/local/texlive/2026basic/texmf-config/web2c/
sudo updmap-sys
